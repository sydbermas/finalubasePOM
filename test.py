...
searchImage = Image.open("screenshot.png")
templateImage = Image.open("7M71906\A\\a.jpg")

# searchImage = Image.open("SavedImages\imageCap.jpg")
# templateImage = Image.open("7W82497\B\\b.jpg")
